...
from sales_points.sale_point_controller import delete_outbounds_controller, get_all_sales_points_controller, login_controller, create_sale_point_controller, get_sale_point, delete_sale_point_controller, logout_controller, delete_all_sales_points_controller, get_outbounds_controller, create_outbound_controller, return_outbounds_controller, delete_orders_controller, edit_sale_point_controller
...
@auth_router.patch("/", status_code=200)  
async def edit(id:int, name: str = None, password: str = None, email: str = None, level: int = None, session = Depends(make_session)):
    sale_point_data = await edit_sale_point_controller(id, name, email, password, level, session)
    return sale_point_data
